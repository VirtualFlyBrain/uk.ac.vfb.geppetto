		...
		try{
			...
			if (debug) {
				...
				if (results.getResults().size() > count) {
					...
					System.out.println("First row: " + results.getResults().get(0).getValues().get(0));
					System.out.println("Last row: " + results.getResults().get(results.getResults().size()-1).getValues().get(0));
				}
			}
